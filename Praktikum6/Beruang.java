...
public class Beruang extends Hewan{
    ...
    public Beruang(){
        System.out.println("              Ini Ciri adalah Hewan Beruang" );
        System.out.println("             -------------------------------");
    }
    
    public Beruang(String nama, String jenisKelamin, float berat, String lokasi, String jenis, String makanan, String suara){
